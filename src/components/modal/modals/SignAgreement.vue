...
export default {
  ...
  mounted: function() {
    ...
    const drawModeDelay = 5; // number of frames to delay drawing just incase the pinch touch is
    ...
    const imageScale = window.innerWidth / img.width;
