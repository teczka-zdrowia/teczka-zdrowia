...
<style lang="scss" scoped>
  ...
  .column {
    ...
    grid-template-areas: "calendar appointments" "patients appointments";
    grid-gap: 1rem;
    width: 100%;
    grid-auto-rows: 28.5rem auto;
  }
  ...
  @media only screen and (max-width: 768px) {
    .column {
      ...
      grid-template-areas: "calendar" "appointments" "patients";
      grid-gap: 1rem;
      width: 100%;
      grid-auto-rows: 28rem auto;
    }
